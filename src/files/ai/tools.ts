    ...
    usd_prices_of_tokens: () => [
      {
        ...
        input_schema: {
          ...
          description: `Token contract address list. Get contract address from list for given token ${JSON.stringify(TOKENS)}`,
        ...
        input_schema: {
          ...
          properties: {
            static_enough: {
              type: 'boolean',
              default: false,
              description: `Just a usual bot question, or question can be answered with ${JSON.stringify(tickerStaticData)}. Or ${question} includes answer. If question not answer with the data provided and not a usual question it is false`,
            },
          },
